class HospitalFinder {
    ...
    this.hospitals = [
      {
        ...
        doctors: [
          { name: "Dr. Phineas Ferb", specialty: "Allergist" },
      ...
      },
      {
        ...
        doctors: [
          { name: "Dr. Maria Santos", specialty: "Cardiologist" },
  ...
  createHospitalCard(hospital) {
    ...
    // Book button - Navigate to doctor profile
    const bookBtn = card.querySelector(".book-btn")
    bookBtn.addEventListener("click", (e) => {
      e.stopPropagation()
      this.navigateToDoctor(hospital)
    })
  ...
  navigateToDoctor(hospital) {
    // Store hospital data in localStorage for the doctor profile page
